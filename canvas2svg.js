...
(function() {
    ...
    ctx = function(o) {
        ...
        this.enableMirroring = options.enableMirroring !== undefined ? options.enableMirroring : defaultOptions
            .enableMirroring;
        ...
        for (i = 0; i < keys.length; i++) {
            ...
            if (style.apply) {
                ...
                if (value instanceof CanvasPattern) {
                    ...
                    if ((style.svgAttr === "stroke" || style.svgAttr === "fill") && value.indexOf("rgba") !==
                        -1) {
    ...
    ctx.prototype.getSerializedSvg = function(fixNamedEntities) {
        ...
        if (xmlns.test(serialized)) {
            serialized = serialized.replace('xmlns="http://www.w3.org/2000/svg',
